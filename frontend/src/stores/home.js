...
export const useHomeStore = defineStore('home', {
    ...
    actions: {
        async fetchDashboardData() {
            ...
            try {
                // Fetch banners
                const bannersRes = await axios.get('http://localhost:8000/api/banners/active')
                this.banners = bannersRes.data.banners || []

                // Fetch quick actions
                const actionsRes = await axios.get('http://localhost:8000/api/services/quick-actions')
